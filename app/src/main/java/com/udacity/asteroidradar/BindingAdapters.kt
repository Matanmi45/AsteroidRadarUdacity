...
import com.udacity.asteroidradar.main.AsteroidRadarAdapter

@BindingAdapter("listData")
fun bindRecyclerView(recyclerView: RecyclerView, data: List<Asteroid>?) {
    val adapter = recyclerView.adapter as AsteroidRadarAdapter
...
fun bindPicture(imageView: ImageView, pictureOfDay: PictureOfDay?) {
